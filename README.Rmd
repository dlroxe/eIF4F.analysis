...
Download `Script` folder of our GitHub repository. `Script` folder contains two scripts: `Download.sh` and `Analysis.R`.
...
Run `Download.sh` from `Script` folder downloaded from our GitHub repository.
