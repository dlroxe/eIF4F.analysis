...
#' [.get_TCGA_CNV_value()]
#'
#' * `TCGA_CNV_sampletype`: the merged dataset from `.TCGA.CNV` that contains
#'  the threshold CNV data generated from [.get_TCGA_CNV()],
#'  and `.TCGA_sampletype` that contains the annotation data from
...
#'  which calculates the ratios of CNV value in each tumor to the average
#'  CNV value from normals in the same cancer type.
#'
#' @details
#'
#' The function also removes possible duplicated tumor samples and
