...
#'  `Gistic2_CopyNumber_Gistic2_all_data_by_genes`. `TCGA_CNV_value` was stored
#'  as `TCGA_CNV_value.csv` in `~/Documents/EIF_output/ProcessedData` folder.
#'
...
#'  are excluded.
#'  `TCGA_CNV_sampletype` was stored as `TCGA_CNV_sampletype.csv` in
...
#'   * `.TCGA_sampletype`
#'  `TCGA_CNVratio_sampletype` was stored as `TCGA_CNVratio_sampletype.csv` in
#'  `~/Documents/EIF_output/ProcessedData` folder.
#'
